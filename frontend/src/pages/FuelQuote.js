      ...
      <div className="quote-container">
        ...
        <form>
          <table>
            <tr>
              <td>
                <label htmlFor="name">Gallons Requested:</label>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <input type="text" id="address" value="123 Main Str" />
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <label htmlFor="email">Suggested Price:</label>{" "}
              </td>
              <td>
                <input type="number" id="price" value={69} />{" "}
              </td>
            </tr>
            <tr>
              <td>
                <label htmlFor="email">Total Amount Due:</label>
              </td>
              <td>
                <input type="number" id="totalDue" value={69 * 4.2} />
              </td>
            </tr>
